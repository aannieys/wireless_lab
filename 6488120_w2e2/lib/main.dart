...
List<TaskInfo> taskInfoList = [
  TaskInfo(location: 'Office', color: Color(0xFFE7F3FF)),
  TaskInfo(location: 'Home', color: Color(0xFFFFE9E1)),
  TaskInfo(location: 'School', color: Color(0xFFE1FFEE)),
];
...
class Progress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TaskInfo taskInfo = taskInfoList.firstWhere(
      ...
      orElse: () => TaskInfo(location: '', color: Colors.grey),
    );
    ...
    return Container(
      ...
      child: Card(
        color: taskInfo?.color ?? Colors.grey,
        shape: RoundedRectangleBorder(
